...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram1_doutb [get_bd_pins axi_bram_ctrl_0_bram1/doutb] [get_bd_pins nn_ctrl_0/out_dout]
  ...
  connect_bd_net -net fix_address_0_addr_out [get_bd_pins fix_address_0/addr_out] [get_bd_pins nn_ctrl_0/nn_int_add]
  ...
  connect_bd_net -net nn_ctrl_0_inp_addres [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins nn_ctrl_0/inp_addres]
  connect_bd_net -net nn_ctrl_0_inp_din [get_bd_pins axi_bram_ctrl_0_bram/dinb] [get_bd_pins nn_ctrl_0/inp_din]
  connect_bd_net -net nn_ctrl_0_inp_enb [get_bd_pins axi_bram_ctrl_0_bram/enb] [get_bd_pins nn_ctrl_0/inp_enb]
  connect_bd_net -net nn_ctrl_0_inp_rst [get_bd_pins axi_bram_ctrl_0_bram/rstb] [get_bd_pins nn_ctrl_0/inp_rst]
  connect_bd_net -net nn_ctrl_0_inp_we [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins nn_ctrl_0/inp_we]
  connect_bd_net -net nn_ctrl_0_out_addres [get_bd_pins axi_bram_ctrl_0_bram1/addrb] [get_bd_pins nn_ctrl_0/out_addres]
  connect_bd_net -net nn_ctrl_0_out_din [get_bd_pins axi_bram_ctrl_0_bram1/dinb] [get_bd_pins nn_ctrl_0/out_din]
  connect_bd_net -net nn_ctrl_0_out_enb [get_bd_pins axi_bram_ctrl_0_bram1/enb] [get_bd_pins nn_ctrl_0/out_enb]
  connect_bd_net -net nn_ctrl_0_out_rst [get_bd_pins axi_bram_ctrl_0_bram1/rstb] [get_bd_pins nn_ctrl_0/out_rst]
  connect_bd_net -net nn_ctrl_0_out_we [get_bd_pins axi_bram_ctrl_0_bram1/web] [get_bd_pins nn_ctrl_0/out_we]
  ...
  connect_bd_net -net nn_inference_0_ap_return [get_bd_pins nn_ctrl_0/prediction] [get_bd_pins nn_inference_0/ap_return]
  ...
  connect_bd_net -net nn_inference_0_input_img_ce0 [get_bd_pins nn_ctrl_0/nn_enb] [get_bd_pins nn_inference_0/input_img_ce0]

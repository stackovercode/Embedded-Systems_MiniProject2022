...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetPosition_message_member_array[1] = {
  {
    "pred",  // name
    ...
    offsetof(dynamixel_sdk_custom_interfaces::msg::SetPosition, pred),  // bytes offset in struct

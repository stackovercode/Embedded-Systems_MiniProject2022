...
static rosidl_typesupport_introspection_c__MessageMember SetPosition__rosidl_typesupport_introspection_c__SetPosition_message_member_array[1] = {
  {
    "pred",  // name
    ...
    offsetof(dynamixel_sdk_custom_interfaces__msg__SetPosition, pred),  // bytes offset in struct
    NULL,  // default value
